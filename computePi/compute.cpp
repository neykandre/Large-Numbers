...
void binarySplit(long long a, long long b, LargeNumbers::LargeNumber &P, LargeNumbers::LargeNumber &Q, LargeNumbers::LargeNumber &R) {
    if (b == a + 1) {
...
LargeNumbers::LargeNumber getPi(long long int precision) {
    ...
    num *= Q;
    long long prevPrecision = LargeNumbers::getGlobalPrecision();
    LargeNumbers::setGlobalPrecision(precision + num.getExp() + 1);
    num /= (LargeNumbers::LargeNumber("13591409") * Q + R);
    LargeNumbers::setGlobalPrecision(prevPrecision);
...
int main(int argc, char* argv[]) {
    ...
    LargeNumbers::LargeNumber myPi = getPi(precision);
