...
TEST(Methods, toString22) {
    LargeNumbers::LargeNumber a = -6156000000_LN;
    EXPECT_EQ(a.toString(), "-6156000000");
}
...
TEST(Methods, fromDouble) {
    LargeNumbers::LargeNumber a = LargeNumbers::LargeNumber(-123.421);
    EXPECT_EQ(a, -123.421_LN);
}

TEST(Methods, setGlobalPrecision) {
    LargeNumbers::LargeNumber a = -0.000000000026048038918855092_LN;
    long long tempPrecision = LargeNumbers::getGlobalPrecision();
    LargeNumbers::setGlobalPrecision(8);
    EXPECT_EQ(a.getInverse(), -38390606030.46556381_LN);
    LargeNumbers::setGlobalPrecision(tempPrecision);
}
...
TEST(Operations, LongMult) {
    LargeNumbers::LargeNumber a = operator ""_LN("6423893352634900302220325774718326467631022623553762359894691820972018"
    ...
    LargeNumbers::LargeNumber b = operator ""_LN("4187461731822090087939302643732290279200306326687514190739806950705106"
    ...
    LargeNumbers::LargeNumber c = operator ""_LN("2689980758346495208172827538985880082154690264725847962689525177080995"
