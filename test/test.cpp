...
TEST(Opearations, DivisionFun) {
    ...
    EXPECT_EQ(1_LN / 1_LN, 1_LN);
    EXPECT_EQ(312311.123132_LN / 1_LN, 312311.123132_LN);
    EXPECT_EQ(0.1_LN / 1_LN, 0.1_LN);
    EXPECT_EQ(0_LN / 1_LN, 0_LN);
    EXPECT_EQ(0.001221_LN / 1_LN, 0.001221_LN);
}